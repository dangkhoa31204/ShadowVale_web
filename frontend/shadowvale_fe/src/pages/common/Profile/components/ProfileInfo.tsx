    ...
    <>
      <div className="border border-border-subtle rounded-lg overflow-hidden flex flex-col sm:flex-row bg-surface-container-low">
        ...
        <div className="p-stack-lg flex-1">
          ...
          <div className="mt-8 flex flex-wrap gap-4 pt-4 border-t border-border-subtle">
            <button 
              onClick={() => setIsEditModalOpen(true)}
              className="bg-primary text-on-primary font-label-caps text-label-caps px-6 py-2 rounded-DEFAULT font-bold transition-colors flex items-center gap-2 hover:opacity-90 cursor-pointer"
            >
            ...
            <Link 
              to="/change-password"
              className="border border-outline-variant text-on-surface font-label-caps text-label-caps px-6 py-2 rounded-DEFAULT transition-colors hover:bg-surface-container-highest flex items-center gap-2"
            >
